...
const SavePostBtn1 = () => {
    return (
        ...
        <button className=" flex items-center gap-2 bg-lime-900 p-2 rounded fill-lime-400 hover:bg-lime-700 cursor-pointer ">
         ...
         <span className="font-bold text-lime-400 text-lg">Save Post</span></button>
